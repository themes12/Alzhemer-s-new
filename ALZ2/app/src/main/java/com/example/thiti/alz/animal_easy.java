...
public class animal_easy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animal_easy);
        ...
        for (int i = 0; i < new Database().ans_animal_easy.length;i++){
            list1.add(new CountryItem(new Database().ans_animal_easy[i], new Database().animal_easy[i]));
        }
        ...
        b_answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b_answer1.getText().toString().equalsIgnoreCase(list1.get(turn - 1).getName())){
                    Toast.makeText(animal_easy.this, "Correct", Toast.LENGTH_SHORT).show();
                    mScore++;
                    ...
                    if (turn < list1.size()){
                        ...
                        Intent intent = new Intent(animal_easy.this, end.class);
                        startActivity(intent);                    }
                }else{
                    Toast.makeText(animal_easy.this, "Wrong", Toast.LENGTH_SHORT).show();
                    mScore--;
                    if(b_answer1.getText() == b_answer2.getText()){
                        b_answer1.setText("ไม่เคย");
                    }else{
        ...
        b_answer2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b_answer2.getText().toString().equalsIgnoreCase(list1.get(turn - 1).getName())){
                    ...
                    Toast.makeText(
                            animal_easy.this, "Wrong", Toast.LENGTH_SHORT).show();
                    mScore--;
                    if(b_answer2.getText() == b_answer1.getText()){
                        b_answer1.setText("ไม่เคย");
                    }else{
