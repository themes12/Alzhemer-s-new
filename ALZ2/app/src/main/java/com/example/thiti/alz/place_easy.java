...
public class place_easy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_place_easy);
        ...
        for (int i = 0; i < new Database().answers1.length;i++){
            list1.add(new CountryItem(new Database().answers1[i], new Database().flags1[i]));
        }
        ...
        b_answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b_answer1.getText().toString().equalsIgnoreCase(list1.get(turn - 1).getName())){
                    Toast.makeText(place_easy.this, "Correct", Toast.LENGTH_SHORT).show();
                    mScore++;
                    ...
                    if (turn < list1.size()){
                        ...
                        Intent intent = new Intent(place_easy.this, end.class);
                        startActivity(intent);                    }
                }else{
                    Toast.makeText(place_easy.this, "Wrong", Toast.LENGTH_SHORT).show();
                    mScore--;
                    if(b_answer1.getText() == b_answer2.getText()){
                        b_answer1.setText("ไม่เคย");
                    }else{
