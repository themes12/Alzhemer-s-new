...
public class place_hard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_place_hard);
        ...
        b_answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b_answer1.getText().toString().equalsIgnoreCase(list.get(turn - 1).getName())){
                    Toast.makeText(place_hard.this, "Correct", Toast.LENGTH_SHORT).show();
                    mScore++;
                    ...
                    if (turn < list.size()){
                        ...
                        Toast.makeText(place_hard.this, "Finish", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(place_hard.this, "Wrong", Toast.LENGTH_SHORT).show();
                    mScore--;
                    if (turn < list.size()){
                        turn++;
                        newQuestion(turn);
