...
public class obj_hard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obj_hard);
        ...
        b_answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b_answer1.getText().toString().equalsIgnoreCase(list.get(turn - 1).getName())){
                    Toast.makeText(obj_hard.this, "Correct", Toast.LENGTH_SHORT).show();
                    mScore++;
                    ...
                    if (turn < list.size()){
                        ...
                        Toast.makeText(obj_hard.this, "Finish", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(obj_hard.this, "Wrong", Toast.LENGTH_SHORT).show();
                    mScore--;
                    if (turn < list.size()){
                        turn++;
                        newQuestion(turn);
